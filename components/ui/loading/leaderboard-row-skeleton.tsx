  ...
  return (
    <div className="flex items-center h-16 px-4 border-b border-border/60">
      ...
      <div className="w-24 text-right">
        <Skeleton className="h-4 w-16 ml-auto bg-gray-800" />
      </div>
      <div className="w-24 text-right hidden sm:block">
        <Skeleton className="h-4 w-12 ml-auto bg-gray-800" />
      </div>
      <div className="w-24 text-right hidden lg:block">
        <Skeleton className="h-4 w-16 ml-auto bg-gray-800" />
      </div>
      <div className="w-20 text-right">
        <Skeleton className="h-4 w-10 ml-auto bg-gray-800" />
      </div>
    </div>
  );
}
    ...
    <div className="rounded-md border border-border/50 overflow-hidden bg-background-card">
      <div className="border-b border-border">
        <div className="flex">
          ...
          <div className="w-24 hidden md:table-cell font-bold text-foreground py-3">
            <Skeleton className="h-3 w-8 bg-gray-800" />
          </div>
          <div className="w-24 text-right font-bold text-foreground py-3">
            <Skeleton className="h-3 w-8 ml-auto bg-gray-800" />
          </div>
          <div className="w-24 text-right hidden sm:table-cell font-bold text-foreground py-3">
            <Skeleton className="h-3 w-10 ml-auto bg-gray-800" />
          </div>
          <div className="w-24 text-right hidden lg:table-cell font-bold text-foreground py-3">
            <Skeleton className="h-3 w-10 ml-auto bg-gray-800" />
          </div>
